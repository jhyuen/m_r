...
class RoleInformationViewController: UIViewController {
    ...
    @IBOutlet weak var roleImg: RoleImg!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        case 0:
            ...
            roleImg.updateImg(pictureName: moderatorImg)
        ...
        case 1:
            ...
            roleImg.updateImg(pictureName: citizenImg)
        ...
        case 2:
            ...
            roleImg.updateImg(pictureName: mafiaImg)
        ...
        case 3:
            ...
            roleAllegiance.text = "PRO-TOWN"
            roleImg.updateImg(pictureName: doctorImg)
        ...
        case 4:
            ...
            roleAllegiance.text = "PRO-TOWN"
            roleImg.updateImg(pictureName: policeImg)
