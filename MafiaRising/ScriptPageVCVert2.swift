...
class ScriptPageVCVert2: UIPageViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource, UIScrollViewDelegate {
    
    lazy var VCArray: [UIViewController] = {
        return [self.VCInstance(name: "ScriptVC3"),
                self.VCInstance(name: "ScriptVC3A")]
    }()
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if currentIndex == 0 && scrollView.contentOffset.y < (scrollView.bounds.size.height - slideOffset) {
            ...
            dismiss(animated: animateSegues, completion: nil)
