...
class ScriptPageVCVert9: UIPageViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource, UIScrollViewDelegate {
    
    lazy var VCArray: [UIViewController] = {
        return [self.VCInstance(name: "ScriptVC12"),
                self.VCInstance(name: "ScriptVC12A")]
    }()
