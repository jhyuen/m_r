...
class CreditsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let art1ByLbl = UILabel()
        let art2ByLbl = UILabel()
        let art3ByLbl = UILabel()
        ...
        creditScrollView.addSubview(art1ByLbl)
        creditScrollView.addSubview(art2ByLbl)
        creditScrollView.addSubview(art3ByLbl)
        ...
        art1ByLbl.frame = CGRect(x: 0, y: 105, width: creditScrollView.frame.width, height: 50)
        art2ByLbl.frame = CGRect(x: 0, y: 160, width: creditScrollView.frame.width, height: 50)
        art3ByLbl.frame = CGRect(x: 0, y: 215, width: creditScrollView.frame.width, height: 50)
        soundEffectsTitleLbl.frame = CGRect(x: 0, y: 275, width: creditScrollView.frame.width, height: 50)
        soundEffectsNoteLbl.frame = CGRect(x: 0, y: 325, width: creditScrollView.frame.width, height: 50)
        soundEffectsByLbl.frame = CGRect(x: 0, y: 375, width: creditScrollView.frame.width, height: 1250)
        ...
        art1ByLbl.font = UIFont(name: "Kefa", size: 20)
        art2ByLbl.font = UIFont(name: "Kefa", size: 20)
        art3ByLbl.font = UIFont(name: "Kefa", size: 20)
      ...
      //  thanksLbl.textColor = UIColor.black
        ...
        art1ByLbl.textColor = UIColor.black
        art2ByLbl.textColor = UIColor.black
        art3ByLbl.textColor = UIColor.black
      ...
      //  thanksLbl.textAlignment = NSTextAlignment.center
        ...
        art1ByLbl.textAlignment = NSTextAlignment.center
        art2ByLbl.textAlignment = NSTextAlignment.center
        art3ByLbl.textAlignment = NSTextAlignment.center
      ...
      // thanksLbl.numberOfLines = 1
        ...
        art1ByLbl.numberOfLines = 2
        art2ByLbl.numberOfLines = 2
        art3ByLbl.numberOfLines = 2
       ...
       // thanksLbl.text = "Thank you for playing!"
        ...
        art1ByLbl.text = "Art by Emily Xu\nIceBreath101@gmail.com"
        art2ByLbl.text = "Art by Isabel Zhao\nisabel.z.zhao@gmail.com"
        art3ByLbl.text = "Art by Daniella Ivanova\nivadanabelle@gmail.com"
